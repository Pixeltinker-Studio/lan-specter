...
class WebUiTests(unittest.TestCase):
    ...
    def test_screensaver_uses_distance_reactive_unconnected_frames(self):
        ...
        self.assertIn("clamp(92 + pursuitDistance * 0.2", screensaver_source)
        self.assertIn("distanceToTarget * 0.014", screensaver_source)
        self.assertIn("const synchronizedTurn = ((synchronizedAngle - freeAngle + 135) % 90) - 45", screensaver_source)
        self.assertIn("captureStartAngle + captureTurn * synchronization", screensaver_source)
